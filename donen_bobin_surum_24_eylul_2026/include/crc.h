...
/**
 * @brief Calculates CRC32 for a data buffer
...
/**
 * @brief Updates a running CRC32 value with a new byte
 * @param crc The current CRC value (not inverted)
 * @param data The new byte to add
 * @return The updated CRC value (not inverted)
 */
